...
const ValidationCell = props => {
  ...
  return (
    <td>
      ...
      />
      {!props.validationLogic(props.dataItem[props.field]) && (
        <Error>This is not valid</Error>
      )}
    </td>
  );
};
...
export const PersonalDetails = props => {
  ...
  //Input text cell
  const MyValidationCell = props => (
    <ValidationCell {...props} validationLogic={minMaxValidation} />
  );
  //Dropdown cell
  ...
  const MyCustomTypeCell = props => <CustomTypeCell {...props} />;
  //Ends Here
